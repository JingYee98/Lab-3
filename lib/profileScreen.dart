      ...
      body: Center(
        child: Column(
          children: <Widget>[
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: CachedNetworkImage(
                              fit: BoxFit.cover,
                              imageUrl:
                                  server+ "/profileimage/${widget.user.email}.jpg?",
            ...
            Expanded(
              child:Container(color: Colors.cyan[100],child: ListView(
                    padding: EdgeInsets.fromLTRB(10, 5, 10, 5),
                    shrinkWrap: true,
                    children: <Widget>[
                  MaterialButton(
                    onPressed: changeName,
                    child: Text("CHANGE YOUR NAME",style: TextStyle(
                        fontSize: 12,
                        fontWeight: FontWeight.bold,
                        color: Colors.black)),
                  ),
                  MaterialButton(
                    ...
                    child: Text("CHANGE YOUR PASSWORD",style: TextStyle(
                        fontSize: 12,
                        fontWeight: FontWeight.bold,
                        color: Colors.black)),
                  ),
                  MaterialButton(
                    ...
                    child: Text("CHANGE YOUR PHONE",style: TextStyle(
                        fontSize: 12,
                        fontWeight: FontWeight.bold,
                        color: Colors.black)),
                  ),
                  MaterialButton(
                    ...
                    child: Text("GO LOGIN SCREEN",style: TextStyle(
                        fontSize: 12,
                        fontWeight: FontWeight.bold,
                        color: Colors.black)),
                  ),
                  ...
                  MaterialButton(
                    onPressed: null,
                    child: Text("BUY STORE CREDIT",style: TextStyle(
                        fontSize: 12,
                        fontWeight: FontWeight.bold,
                        )),
                  ),
              ...
              content: new Column(
                ...
                children: <Widget>[
                  TextField(
                      ...
                      obscureText: true,
                      decoration: InputDecoration(
                        labelText: 'Old Password',labelStyle:TextStyle(color:Colors.white),
                        icon: Icon(
                          Icons.lock,
                          color: Colors.cyan[100],
                        ),
          ...
          return AlertDialog(
            backgroundColor: Colors.indigo[900],
              ...
              content: new TextField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'New Phone Number',labelStyle:TextStyle(color:Colors.white),
                    icon: Icon(
                      Icons.phone,
                      color: Colors.cyan[100],
                    ),
