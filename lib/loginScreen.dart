...
import 'package:clofident/mainScreen.dart';
import 'package:clofident/registerScreen.dart';
import 'package:clofident/user.dart';
                  ...
                  Future<bool> _onBackPressed() {
                    return showDialog(
                          ...
                          builder: (context) => new AlertDialog(backgroundColor: Colors.indigo[900],
                            ...
                            content: new Text('Do you want to exit Clofident App',style: TextStyle(color: Colors.white)),
                            actions: <Widget>[
                              MaterialButton(
                                  onPressed: () {
                                    SystemChannels.platform.invokeMethod('SystemNavigator.pop');
                                  },
                                  child: Text("Exit",style: TextStyle(color: Colors.cyan[100]))),
                              MaterialButton(
                                  onPressed: () {
